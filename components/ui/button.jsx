...
const buttonVariants = cva(
  ...
  "inline items-center justify-center border-2 font-bold text-center transition cursor-pointer",
  {
    variants: {
      variant: {
        ...
        sg_drawer_close: "bg-transparent border-black text-(--sg-green) hover:bg-(--sg-green) hover:border-(--sg-green) hover:text-white text-sm rounded-3xl",
