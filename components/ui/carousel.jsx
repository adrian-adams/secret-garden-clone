...
function CarouselContent({
  ...
  return (
    <div
      ref={carouselRef}
      className="overflow-hidden rounded-4xl gap-0"
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("gsap-prev absolute size-8 rounded-full hover:text-white", orientation === "horizontal"
...
function CarouselNext({
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("gsap-next absolute size-8 rounded-full m-auto hover:text-white", orientation === "horizontal"
